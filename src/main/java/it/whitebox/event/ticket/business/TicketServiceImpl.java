...
import it.whitebox.event.ticket.integration.db.PurchaseDao;
import it.whitebox.event.ticket.integration.db.PurchaseDaoCustom;
import it.whitebox.event.ticket.integration.db.ServiceDao;
import it.whitebox.event.ticket.integration.db.SubscriberDao;
import it.whitebox.event.ticket.integration.db.SubscriptionDao;
import it.whitebox.event.ticket.integration.db.SubscriptionDaoCustom;
import it.whitebox.event.ticket.integration.db.TicketDao;
...
public class TicketServiceImpl implements TicketService {
	...
	public CreatePurchaseResponse createPurchase(Purchase purchase) {
		...
		for (Iterator<Ticket> i=purchase.getTicketList().iterator(); i.hasNext();) {
			...
			it.whitebox.event.ticket.business.domain.Service service = 
